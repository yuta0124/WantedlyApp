...
sealed class UiError(@StringRes val messageRes: Int) {
    data class BadRequestError(@StringRes val res: Int = R.string.bad_request_error_message) : UiError(res)
    ...
    data class UnexpectedError(@StringRes val res: Int = R.string.unexpected_error_message) : UiError(res)
